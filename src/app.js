...
function generateAnExcuse(array1, array2, array3, array4) {
  let newExcuse = "";
  newExcuse = newExcuse.concat(array1[generateNumber(array1)]," ",array2[generateNumber(array2)]," ",array3[generateNumber(array3)]," ",array4[generateNumber(array4)]);
  return newExcuse;
}
...
window.loaded = () => {document.getElementById("excuse").innerHTML = generateAnExcuse(who,action,what,when);};
